...
// MongoDB Connection
const MONGODB_URI = 'mongodb://localhost:27017/infinite_learning';
...
app.post('/api/signup', async (req, res) => {
    try {
        ...
        const { fullName, branch, year, rollNo, email, password } = req.body;
        ...
        const newUser = new User({ fullName, branch, year, rollNo, email, password: hashedPassword });
        await newUser.save();
